...
import { Drawer, List, ListItem, ListItemButton, ListItemIcon, ListItemText, AppBar, Toolbar, IconButton, Typography, Box, Divider, Tooltip, Fab } from '@mui/material';
...
import SystemStatusReason from './SystemStatusReason';
...
const WaiterPage = ({ onLogout }: WaiterPageProps) => {
          ...
          <Box sx={{
            ...
            <RestaurantIcon 
              sx={{ 
                color: 'white', 
                fontSize: 32,
                display: import.meta.env.VITE_RESTAURANT_LOGO ? 'none' : 'flex'
              }} 
            />
          </Box>
      ...
      <List sx={{ pt: 2 }}>
        ...
        <Box sx={{ px: 2, mb: 2 }}>
          ...
          <Box sx={{ 
            ...
            {/* Mostrar motivo quando pedidos estão bloqueados */}
            <SystemStatusReason />
          </Box>
        </Box>
    ...
    <Box sx={{ 
      ...
      >
        <Toolbar sx={{ minHeight: '64px !important' }}>
          ...
          >
            {import.meta.env.VITE_APP_TITLE || 'Sistema de Pedidos'}
          </Typography>
